...
const dances = [
  {character:'fox',label:'Fox',phase:'Step · turn · clap',
    note:'The approved 76,541-byte release includes rounded turn-entry hands, continuous torso/leg joins, repaired cheek edges, balanced stepping and a complete rear tail reusing the opening sway. Compare its 4.633 seconds with the original WebP; the source’s extra final hold is omitted.'},
